        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="w-full flex justify-center">
                    <div class="flex flex-col mr-3 gap-3" id="imageContainer">
                    </div>
                    <div
                        class="w-full md:h-[35vh] md:w-[70%] relative grid grid-cols-1 md:grid-cols-3 border border-gray-300 bg-gray-100 rounded-lg">
                        <div
                ...
                <div class="form-group">
                    ...
                    <textarea required name="desc" class="form-control" id="description" rows="3"
                ...
                <!-- Tags Field-->
                <div class="mt-5 form-group flex flex-col">
                    <label for="tags" class="form-label">Select Tags</label>
                    <select required id="tags" name="tags[]" class="form-control border-gray-100 p-2" multiple>
                ...
                <div id="errors" class="mt-3 flex flex-wrap gap-2"></div>
