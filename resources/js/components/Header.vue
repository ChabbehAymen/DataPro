...
const classObject = computed(() => ({
  'translate-x-0': isSidebarOpen.value == true,
  '-translate-x-full': isSidebarOpen.value === false
}));
    ...
    <div class="flex flex-col">
        ...
        <div
            ...
            <div class="mb-2 p-4 flex items-center justify-around">
                ...
                <button @click="toggleSidebar" id="btnSidebarToggler" type="button" class="py-4 text-2xl text-black hover:text-gray-200">
